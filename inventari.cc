...
void Inventari::poner_prod(const string& prod_id) {
...
void Inventari::mostra(const bool& show_zeros) const {
    for (const pair<string, unsigned int>& element : Inventari::comptador)
